...
class FileExplorer(object):
    ...
    def __init__(self, root, window):
        ...
        self.tree_style.configure("remapy.style.Treeview", highlightthickness=0, bd=0, font=self.font, rowheight=self.row_height)
        self.tree_style.configure("remapy.style.Treeview.Heading", font=self.font)
        ...
        self.tree.column("#0", minwidth=int(250*scaling))
        self.tree.column("#1", width=int(200*scaling), stretch=tk.NO)
        self.tree.column("#2", width=int(130*scaling), anchor="center", stretch=tk.NO)
        ...
        self.context_menu =tk.Menu(root, tearoff=0, font=self.font)
